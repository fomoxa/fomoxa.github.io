...
PAGES = {
    ...
    'comparison': {
        'en': ('Comparison', 'How Fomoxa differs from Protocol Buffers, FlatBuffers, Cap’n Proto, JSON and MessagePack. Differences, not rankings.'),
        'vi': ('So sánh', 'Fomoxa khác Protocol Buffers, FlatBuffers, Cap’n Proto, JSON và MessagePack ở đâu. Chỉ nói khác nhau, không xếp hạng.'),
    },
    'use-cases': {
